...
<liferay-ui:search-container>
    ...
    <liferay-ui:search-container-row
        ...
        <liferay-ui:search-container-column-text property="regionName" name="regionName" title="Region name"/>
        <liferay-ui:search-container-column-text property="regionCode" name="regionCodes" title="Region code"/>
