...
import ru.kotikov.model.FarmerClp;
import ru.kotikov.model.RegionClp;
...
public class ClpSerializer {
        ...
        synchronized (ClpSerializer.class) {
            ...
            try {
                ...
                String portletPropsServletContextName = (String) getMethod.invoke(null,
                        "LiferayRegionAndFarmerRegistry-portlet-deployment-context");
            ...
            if (Validator.isNull(_servletContextName)) {
                _servletContextName = "LiferayRegionAndFarmerRegistry-portlet";
            }
    ...
    public static Object translateOutput(BaseModel<?> oldModel) {
        ...
        if (oldModelClassName.equals("ru.kotikov.model.impl.FarmerImpl")) {
        ...
        if (oldModelClassName.equals("ru.kotikov.model.impl.RegionImpl")) {
    ...
    public static Throwable translateThrowable(Throwable throwable) {
        ...
        if (className.equals("ru.kotikov.NoSuchFarmerException")) {
            return new ru.kotikov.NoSuchFarmerException();
        }

        if (className.equals("ru.kotikov.NoSuchRegionException")) {
            return new ru.kotikov.NoSuchRegionException();
        }
